  ...
  return (
    <div className="bg-white p-10 rounded-[2.5rem] shadow-xl border border-slate-100 text-center">
      ...
      <p className="text-[10px] text-slate-500 font-bold uppercase tracking-wider max-w-sm mx-auto leading-relaxed">
        AR Inspection Mode requires a WebXR-capable mobile browser (Chrome on Android or Safari on iOS 17+ with ARKit support). Please switch to a compatible mobile device to use live surface tracking and anchoring.
      </p>
    </div>
  )
}
